...
const Card = () => {
  ...
  return (
    <div className="border border-black rounded-[63px] bg-[#d9d9d933] w-[350px] h-[420px] sm:w-[541px] sm:h-[385px] flex flex-col items-center justify-center font-['outfit'] text-white">
      ...
      <Button onClick={() => router.push(`http://localhost:5000/auth/42`) } className="rounded-full flex items-center justify-center bg-gradient-to-r from-[#8d8dda80] to-[#ABD9D980]">
        Sign in with
        <Image className="ml-[5px] mt-[3px]" src={"/42.png"} alt="image" width={21} height={16}/>
      </Button>
    </div>
  );
};
